...
/***/ function(module, exports, __webpack_require__) {
	...
	var _trialsLayout = __webpack_require__(159);

	var _trialsLayout2 = _interopRequireDefault(_trialsLayout);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	fetch('data.json').then(function (response) {
	  response.json().then(function (json) {
	    _reactDom2.default.render(_react2.default.createElement(_trialsLayout2.default, { trials: json.trials }), document.getElementById('trials-layout'));
	  });
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _trial = __webpack_require__(160);
	...
	var TrialsLayout = function (_React$Component) {
	  _inherits(TrialsLayout, _React$Component);

	  function TrialsLayout() {
	    _classCallCheck(this, TrialsLayout);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(TrialsLayout).apply(this, arguments));
	  }

	  _createClass(TrialsLayout, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'TrialsLayout' },
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'Trials__legend' },
	          _react2.default.createElement(
	            'p',
	            { style: { color: _colors2.default.agents } },
	            _react2.default.createElement('span', { className: 'Trials__legend-dot', style: { backgroundColor: _colors2.default.agents } }),
	            ' Connected Agent'
	          ),
	          _react2.default.createElement(
	            'p',
	            { style: { color: _colors2.default.members } },
	            _react2.default.createElement('span', { className: 'Trials__legend-dot', style: { backgroundColor: _colors2.default.members } }),
	            ' Invited Member'
	          ),
	          _react2.default.createElement(
	            'p',
	            { style: { color: _colors2.default.builds } },
	            _react2.default.createElement('span', { className: 'Trials__legend-dot', style: { backgroundColor: _colors2.default.builds } }),
	            ' Ran a Build'
	          )
	        ),
	        _react2.default.createElement(
	          ...
	          this.props.trials.map(function (trial) {
	            return _react2.default.createElement(_trial2.default, { key: trial.slug, trial: trial });
	          })
	        )
	      );
	    }
	...
	TrialsLayout.propTypes = {
	  trials: _react2.default.PropTypes.array.isRequired
	};
	;

	exports.default = TrialsLayout;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _piechart = __webpack_require__(161);
	...
	var Trial = function (_React$Component) {
	  ...
	  function Trial() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Trial).apply(this, arguments));
	  }

	  _createClass(Trial, [{
	    key: 'render',
	    value: function render() {
	      var classNames = "Trial " + (this.props.trial.agent_count != 0 ? "Trial--agents" : "");

	      return _react2.default.createElement(
	        'div',
	        { className: classNames, title: this.props.trial.name },
	        _react2.default.createElement(
	          'div',
	          { style: { position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', zIndex: 2 } },
	          this._chartLabel(this.props.trial.agent_count, 0, { top: -2, left: 'calc(50% - 1.25em)', borderColor: _colors2.default.agents, color: _colors2.default.agents }, 'Agents'),
	          this._chartLabel(this.props.trial.member_count, 1, { top: '60%', right: '.25em', borderColor: _colors2.default.members, color: _colors2.default.members }, 'Members'),
	          this._chartLabel(this.props.trial.build_count, 0, { top: '60%', left: '.25em', borderColor: _colors2.default.builds, color: _colors2.default.builds }, 'Builds')
	        ),
	        _react2.default.createElement(
	          'div',
	          { style: { position: 'absolute', top: 0, left: 0, zIndex: 1, width: '100%', height: '100%', transform: 'rotate(210deg)' } },
	          _react2.default.createElement(_piechart2.default, {
	            data: this._chartData(),
	            sectorStrokeColor: _colors2.default.background,
	            viewBoxWidth: 85,
	            sectorStrokeWidth: 1 })
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: 'Trial__name' },
	          _react2.default.createElement(
	            'span',
	            null,
	            this.props.trial.name
	          )
	        ),
	        _react2.default.createElement(
	          'div',
	    ...
	    key: '_chartData',
	    value: function _chartData() {
	      var inactive = _colors2.default.inactive;
	      return [{ value: 100, color: this.props.trial.agent_count > 0 ? _colors2.default.agents : inactive }, { value: 100, color: this.props.trial.member_count > 1 ? _colors2.default.members : inactive }, { value: 100, color: this.props.trial.build_count > 0 ? _colors2.default.builds : inactive }];
	    }
	  }, {
	    key: '_chartLabel',
	    value: function _chartLabel(number, showIfGreaterThan, style, title) {
	      if (number > showIfGreaterThan) {
	        return _react2.default.createElement(
	          'span',
	          { className: 'Trial__chart-label', style: style, title: title },
	          number
	        );
	      }
	    }
	...
	Trial.propTypes = {
	  trial: _react2.default.PropTypes.shape({
	    name: _react2.default.PropTypes.string,
	    slug: _react2.default.PropTypes.string,
	    agent_count: _react2.default.PropTypes.number,
	    agent_connected_count: _react2.default.PropTypes.number,
	    agents_os: _react2.default.PropTypes.arrayOf(_react2.default.PropTypes.string),
	    pipeline_count: _react2.default.PropTypes.number,
	    member_count: _react2.default.PropTypes.number,
	    build_count: _react2.default.PropTypes.number,
	    first_member: _react2.default.PropTypes.shape({
	      name: _react2.default.PropTypes.string,
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } // Modified and simplified version of
	...
	var PieChart = function (_React$Component) {
	  ...
	  _createClass(PieChart, [{
	    ...
	    value: function getSectors() {
	      ...
	      var sectorStrokeColor = _props.sectorStrokeColor;
	      ...
	      return data.map(function (d, i) {
	        ...
	        var x1 = Math.round(center + center * Math.cos(Math.PI * startAngle / 180));
	        var y1 = Math.round(center + center * Math.sin(Math.PI * startAngle / 180));

	        var x2 = Math.round(center + center * Math.cos(Math.PI * endAngle / 180));
	        var y2 = Math.round(center + center * Math.sin(Math.PI * endAngle / 180));

	        var dPath = 'M' + center + ',' + center + ' ' + 'L' + x1 + ',' + y1 + ' ' + 'A' + center + ',' + center + ' 0 ' + largeArc + ',1 ' + x2 + ',' + y2 + ' ' + 'z';
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'svg',
	        _extends({ viewBox: '0 0 ' + viewBoxWidth + ' ' + viewBoxWidth }, props),
	        this.getSectors()
	      );
	    }
	  }]);
	...
	PieChart.propTypes = {
	  ...
	  sectorStrokeColor: _react2.default.PropTypes.string,
	  sectorStrokeWidth: _react2.default.PropTypes.number,
	  viewBoxWidth: _react2.default.PropTypes.number
	};
